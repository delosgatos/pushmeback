...
! function e(t, i, n) {
                ...
                return o(t, [{
                    ...
                    value: function() {
                        var t = {
                                ru: {
                                    title: {
                                        allow: "Спасибо что подписались!",
                                        "default": "Кликните &laquo;Разрешить&raquo;, чтобы подписаться.",
                                        deny: "Вы заблокировали подписку",
                                        subscribe: "Вы подписаны на рассылку."
                                    },
                                    errors: {
                                        serviceWorker: "Не удалось зарегистрироваться Service workers",
                                        serviceWorkerSupported: "Service workers не поддерживаются в этом браузере",
                                        showNotificationSupported: "Notifications не поддерживаются в этом браузере",
                                        notificationDenied: "Вы заблокировали подписку",
                                        pushAPISupported: "Push messaging не поддерживаются в этом браузере",
                                        noSupported: "Браузер не поддерживает Web Push"
                                    }
                                },
                                en: {
                                    title: {
                                        allow: "Thank you for subscribing!",
                                        "default": "Click &laquo;Allow&raquo;, to subscribe.",
                                        deny: "You have blocked subscription",
                                        subscribe: "You are subscribed to our newsletter."
                                    },
                                    errors: {
                                        serviceWorker: "Failed to register Service workers",
                                        serviceWorkerSupported: "Service workers are not supported in this browser",
                                        showNotificationSupported: "Notifications are not supported in this browser",
                                        notificationDenied: "You have blocked subscription",
                                        pushAPISupported: "Push messaging are not supported in this browser",
                                        noSupported: "Browser does not support Web Push"
                                    }
                                }
                            },
                            i = e.user.lang,
                    ...
                    return o(r, [{
                        ...
                        value: function s() {
                            ...
                            return t.utilites.debugConsole({
                                ...
                                time: !0
                            }), s || t.utilites.infoConsole('File manifest.json is not connected to DOM. Paste into tag head <link rel="manifest" href="/manifest.json">'), s
                        }
                    }, {
    ...
    6: [function(e, t, i) {
        ...
        t.exports = function(t) {
            var i = function() {
                function i() {
                    n(this, i), this.message = this.getMessage(), this.title = document.getElementById("pwl__title")
                }
                return o(i, [{
                    key: "getMessage",
                    value: function() {
                        var i = e("modules/core/landing/message")(t);
                        return i.get()
                    }
                }, {
                    key: "setMessage",
                    value: function(e) {
                        document.body.classList.add("" + e.name), this.title.innerHTML = "" + e.text, t.utilites.debugConsole({
                            name: "Debug (class Status) -> setMessage",
                            params: {
                                className: e.name,
                                message: e.text
                            },
                    ...
                    key: "setClass",
                    value: function() {
                        var e = this.getOsClass(),
                            i = this.getBrowserClass(),
                            n = document.body;
                        n.classList.add(e, i), t.utilites.debugConsole({
                            name: "Debug (class Status) -> setClass",
                            params: {
                                os: e,
                                browser: i
                            },
                    ...
                    key: "eventListener",
                    value: function() {
                        var e = document.querySelector(".pwl__footer--link");
                        e && e.addEventListener("click", function(i) {
                            e.href = t.utilites.getPWUrl("landing", t.user.device_id)
                        })
                    }
                }, {
                    key: "setListener",
                    value: function() {
                        var e = this,
                            t = ["landing-allow", "landing-default", "landing-deny"];
                            ...
                            document.addEventListener(t, function(t) {
                                switch (t.detail.value) {
                                    case "allow":
                                        e.setMessage({
                                            name: "pw-subscribe",
                                            text: e.message.title.allow
                                        });
                                        break;
                                    case "deny":
                                        e.setMessage({
                                            name: "pw-errors",
                                            text: e.message.errors.notificationDenied
                                        });
                                        break;
                                    case "default":
                    ...
                    key: "getBrowserClass",
                    value: function() {
                        var e = t.user.browser ? t.user.browser.toLowerCase() : "default";
                        return "pwl-browser--" + e
                    }
                }, {
                    key: "init",
                    value: function(e, i) {
                        var n = this;
                        if (this.setClass(), this.setListener(), this.eventListener(), t.utilites.setStataData({
                                event_id: "permission_show"
                            }), t.utilites.debugConsole({
                                name: "Debug (class Status) -> Init",
                                params: {
                                    context: this,
                                    allowed: e,
                                    permission: i
                            ...
                            case "allow":
                                t.subscription.register().then(function() {
                                    t.subscription.getSubscription(function(e) {
                                        e ? t.subscription.updatePushbookmark() : t.subscription.init(), n.setMessage({
                                            name: "pw-subscribe",
                                            text: n.message.title.subscribe
                                        })
                                    })
                                });
                                break;
                            case "deny":
                                this.setMessage({
                                    name: "pw-errors",
                                    text: this.message.errors.notificationDenied
                                }), t.utilites.setStataData({
                                    event_id: "permission_errors",
                                    errorCode: "notificationDenied",
                                    errorText: this.message.errors.notificationDenied
                                });
                                break;
                            default:
                                t.subscription.init()
                            ...
                            name: "pw-errors",
                            text: this.message.errors.noSupported
                        }), t.utilites.setStataData({
                            event_id: "permission_errors",
                            errorCode: "noSupported",
                            errorText: this.message.errors.noSupported,
                            is_supported: e
                        })
                    }
                }]), i
        ...
        "modules/core/landing/message": 2
    }],
    7: [function(e, t, i) {
        "use strict";
        ...
        ! function(t, i) {
            ...
            r.config = {
                ...
                var s = {},
                    a = function() {
                        function s() {
                            n(this, s), this.type = "landing", this.debug = this.getDebug(), this.platform_code = "459bb05f959eb81301656d8a2f80a32709034b4ed4122118a0490ff3694c430b", this.user = {}, this.api = {
                                host: "https://xripru.push.world",
                                device: "https://xripru.push.world/getid/?code=" + this.platform_code,
                                events: "https://api.push.world/v1/event",
                                data: "https://api.push.world/v1/subscribe",
                                landing: "https://xripru.push.world",
