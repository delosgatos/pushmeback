...
! function t(n, e, r) {
    ...
    1: [function(t, n, e) {
        ...
        ! function() {
            ...
            var t = {
                    PLATFORM_CODE: "df632a59c4c23f32fdeafb5d764da62e4efa8c17460b509a9432e6d85ba69c2f",
                    VERSION: "1.4.3",
                    payload: function(t) {
                ...
                openWindow = function(t, n) {
                    return t.waitUntil(clients.matchAll({
                        ...
                        return clients.openWindow ? clients.openWindow(n) : void 0
                    }))
                };
